...
<main id="main">
  ...
  <table class="table">
    <thead>
    <tr>
      <th style="width: 180px ; text-align: center">userName</th>
      <th style="width: 100px ;text-align: center">passWord</th>
      <th style="width: 100px ;text-align: center">address</th>
      <th style="width: 100px ;text-align: center">birthday</th>
      <th style=" width: 50px ; text-align: center">id_role</th>
    </tr>
    </thead>
    <tbody>
    <c:forEach items="${acount}" var="acc">
      <form action="/QLAccount" method="post">
        <tr>
          <td>
            <input name="username" value="${acc.username}" style=" width: 180px ;" readonly>
          </td>
          <td>
            <input name="password" value="${acc.password}" style=" width: 100px ;" readonly>
          </td>
          <td>
            <input name="address" value="${acc.address}" style=" width: 100px ;" readonly>
          </td>
          <td>
            <input name="birthday" value="${acc.birthday}" style=" width: 100px ;" readonly>
          </td>
          <td>
            <input name="id_role" value="${acc.id_role}" style=" width: 100px ;" >
          </td>
          <td>
