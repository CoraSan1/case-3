...
<%--    </div>--%>
    <nav id="navbar" class="nav-menu navbar">
      <ul>
        ...
        <li><a href="/Cart_Product" class="nav-link scrollto"><i class="bx bx-book-content"></i>
          ...
          <form method="get" action="/ProductServlet_CartEdit">
            <tr>
              <td style="text-align: center">
                <input class="input-qty" name="name"
                       value="${sp.name}" readonly style=" width: 100px ; text-align: center">
              </td>
              <td style="text-align: center"><img src="${sp.img}" width="100" height="100"></td>
              <td>
                <input class="input-qty" max="${amountMax}" min="1" name="amount" type="number"
                       value="${sp.amount}" style=" width: 100px ; text-align: center">
              </td>
              <td style="text-align: center">Giá: ${sp.price}/ 1sp</td>
              <td style="text-align: center">
