        ...
        <div class="section-title">
            ...
            <c:forEach items="${product}" var="sp">
                <form action="/Buy_Product" method="get">
                    <img src="${sp.img}" alt="" width="100" height="100">
                    <input name="name" value="${sp.name}" readonly>
                    <a style="text-align: center">Giá: ${sp.price}</a>
                    <input class="input-qty" max="${sp.price}" min="1" name="price" type="number" value="1"
